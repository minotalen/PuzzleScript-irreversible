...
var title_options = [[
	".............continue.............",
	"..........888ontinu888...........",
	"888888888888888ntin888888888888888"
], [
	"...........level select...........",
	".........888evel selec888.........",
	"##########.level select.##########"
	...
	".............settings.............",
	"..........888etting888...........",
	"8888888888888settin88888888888888"
], [
	".............new game.............",
	"...........888ew gam888..........",
	"888888888888888w ga88888888888888"
]];
...
function processInput(dir,dontDoWin,dontModify) {
    ...
    if (dir<=4) {
		...
		if(!winning && level.commandQueue.indexOf('irreversible')>=0) {
			if (verbose_logging) {
				var r = level.commandQueueSourceRules[level.commandQueue.indexOf('irreversible')];
				consolePrintFromRule('irreversible command executed, deleting undo cache.',r);
			}
			backups = [];
			save_backup = false;
		}
